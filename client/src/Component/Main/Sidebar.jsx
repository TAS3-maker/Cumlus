...
import { Folder, Plus, Check, Mic, CircleArrowUp, Users, CircleAlertIcon, User, Camera, EllipsisVertical } from "lucide-react";
...
const Sidebar = ({ onFolderSelect }) => {
    ...
    return (
        ...
        <div className="hidden md:flex flex-col w-64 bg-gray-100 p-4 space-y-4 min-h-screen ">
            <div style={{ width: "25vw", maxWidth: "none" }} className="mb-5">
                <img src={logo} alt="Cumulus Logo" style={{ width: "100vw", height: "50px" }} />
            </div>
