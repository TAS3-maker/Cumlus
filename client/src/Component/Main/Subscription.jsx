...
const Subscription = () => {
  ...
  {row.foundation ? <Check className=" text-center text-green-500 font-bold" /> : ""}
                ...
                <td className="md:px-4 py-2 text-center">{row.legacy ? <Check className=" text-center text-green-500 text-lg font-bold" /> : ""}</td>
                <td className="md:px-4 py-2 text-center">{row.heritage ? <Check className=" text-center text-green-500 font-bold"  />: ""}</td>
              </tr>
            ))}
          </tbody>
        </table>
